...
Shader "M3DS/Particle"
{
	Properties
	{
		...
		[ASEEnd]_DepthFadeDistance("Depth Fade Distance", Range( 0 , 10)) = 2
	...
	SubShader
	{
		...
		Pass
		{
						...
						)
			{
				...
				float screenDepth87 = LinearEyeDepth(SampleCameraDepth( ase_screenPosNorm.xy ),_ZBufferParams);
				float distanceDepth87 = abs( ( screenDepth87 - LinearEyeDepth( ase_screenPosNorm.z,_ZBufferParams ) ) / ( _DepthFadeDistance ) );
				float clampResult88 = clamp( distanceDepth87 , 0.0 , 1.0 );
				
				surfaceDescription.BaseColor = ( tex2DNode21 * _Color * packedInput.ase_color ).rgb;
				...
				surfaceDescription.Alpha = ( ( tex2DNode21.a * _Color.a * packedInput.ase_color.a ) * clampResult88 );
...
/*ASEBEGIN
Version=19108
Node;AmplifyShaderEditor.RangedFloatNode;86;-1429.215,-1013.699;Inherit;False;Property;_DepthFadeDistance;Depth Fade Distance;2;0;Create;True;0;0;0;False;0;False;2;2;0;10;0;1;FLOAT;0
Node;AmplifyShaderEditor.ColorNode;28;-1327.92,-520.4959;Inherit;False;Property;_Color;Color;0;0;Create;True;0;0;0;False;0;False;0,0,0,0;1,1,1,1;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.DepthFade;87;-1026.215,-1031.699;Inherit;False;True;False;True;2;1;FLOAT3;0,0,0;False;0;FLOAT;1;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.ClampOpNode;88;-751.2148,-1047.699;Inherit;False;3;0;FLOAT;0;False;1;FLOAT;0;False;2;FLOAT;1;False;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;90;-722.5592,-258.8145;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
...
WireConnection;75;9;90;0
ASEEND*/
//CHKSM=C0D7E5DAF33FDB4FCAEB898C1D5017AAB51A4D9F