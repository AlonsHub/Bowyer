	...
	SubShader
	{
		...
		Pass
		{
			...
			PackedVaryingsMeshToPS VertexFunction(AttributesMesh inputMesh )
			{
				...
				float2 texCoord138 = inputMesh.ase_texcoord.xy * _Tiling + float2( 0,0 );
						...
						)
			{
				...
				float WaveSpeed19 = ( _TimeParameters.x * _Speed * 0.5 );
				float2 WaveDirection127 = _Direction1;
				float2 texCoord138 = packedInput.ase_texcoord5.xy * _Tiling + float2( 0,0 );
				float2 WorldSpaceTile7 = texCoord138;
				float2 WaveTileUV22 = ( ( WorldSpaceTile7 * float2( 1,1 ) * 0.1 ) * _MainTile );
				float2 panner56 = ( WaveSpeed19 * WaveDirection127 + WaveTileUV22);
				float2 Panner1146 = panner56;
				...
				float4 clampResult167 = clamp( ( ( break163.a * _Alpha ) * ( packedInput.ase_color * _VertexFadeAmount ) ) , float4( 0,0,0,0 ) , float4( 1,1,1,0 ) );
				float4 screenPos = packedInput.ase_texcoord6;
				float4 ase_screenPosNorm = screenPos / screenPos.w;
				ase_screenPosNorm.z = ( UNITY_NEAR_CLIP_VALUE >= 0 ) ? ase_screenPosNorm.z : ase_screenPosNorm.z * 0.5 + 0.5;
				float screenDepth114 = LinearEyeDepth(SampleCameraDepth( ase_screenPosNorm.xy ),_ZBufferParams);
				...
				surfaceDescription.BaseColor = appendResult164.xyz;
				...
				surfaceDescription.Alpha = ( clampResult167 * Edge123 ).r;
		...
		Pass
		{
			...
			PackedVaryingsMeshToPS VertexFunction(AttributesMesh inputMesh  )
			{
				...
				float WaveSpeed19 = ( _TimeParameters.x * _Speed * 0.5 );
				float2 WaveDirection127 = _Direction1;
				float2 texCoord138 = inputMesh.uv0.xy * _Tiling + float2( 0,0 );
				float2 WorldSpaceTile7 = texCoord138;
				float2 WaveTileUV22 = ( ( WorldSpaceTile7 * float2( 1,1 ) * 0.1 ) * _MainTile );
				float2 panner56 = ( WaveSpeed19 * WaveDirection127 + WaveTileUV22);
				float2 Panner1146 = panner56;
			...
			float4 Frag(PackedVaryingsMeshToPS packedInput  ) : SV_Target
			{
				...
				float WaveSpeed19 = ( _TimeParameters.x * _Speed * 0.5 );
				float2 WaveDirection127 = _Direction1;
				float2 texCoord138 = packedInput.ase_texcoord2.xy * _Tiling + float2( 0,0 );
				float2 WorldSpaceTile7 = texCoord138;
				float2 WaveTileUV22 = ( ( WorldSpaceTile7 * float2( 1,1 ) * 0.1 ) * _MainTile );
				float2 panner56 = ( WaveSpeed19 * WaveDirection127 + WaveTileUV22);
				float2 Panner1146 = panner56;
		...
		Pass
		{
					...
					)
			{
				...
				float WaveSpeed19 = ( _TimeParameters.x * _Speed * 0.5 );
				float2 WaveDirection127 = _Direction1;
				float2 texCoord138 = packedInput.ase_texcoord1.xy * _Tiling + float2( 0,0 );
				float2 WorldSpaceTile7 = texCoord138;
				float2 WaveTileUV22 = ( ( WorldSpaceTile7 * float2( 1,1 ) * 0.1 ) * _MainTile );
				float2 panner56 = ( WaveSpeed19 * WaveDirection127 + WaveTileUV22);
				float2 Panner1146 = panner56;
		...
		Pass
		{
					...
					)
			{
				...
				float WaveSpeed19 = ( _TimeParameters.x * _Speed * 0.5 );
				float2 WaveDirection127 = _Direction1;
				float2 texCoord138 = packedInput.ase_texcoord3.xy * _Tiling + float2( 0,0 );
				float2 WorldSpaceTile7 = texCoord138;
				float2 WaveTileUV22 = ( ( WorldSpaceTile7 * float2( 1,1 ) * 0.1 ) * _MainTile );
				float2 panner56 = ( WaveSpeed19 * WaveDirection127 + WaveTileUV22);
				float2 Panner1146 = panner56;
		...
		Pass
		{
						...
						)
			{
				...
				float WaveSpeed19 = ( _TimeParameters.x * _Speed * 0.5 );
				float2 WaveDirection127 = _Direction1;
				float2 texCoord138 = packedInput.ase_texcoord7.xy * _Tiling + float2( 0,0 );
				float2 WorldSpaceTile7 = texCoord138;
				float2 WaveTileUV22 = ( ( WorldSpaceTile7 * float2( 1,1 ) * 0.1 ) * _MainTile );
				float2 panner56 = ( WaveSpeed19 * WaveDirection127 + WaveTileUV22);
				float2 Panner1146 = panner56;
...
Node;AmplifyShaderEditor.Vector2Node;168;-5333.764,-2431.603;Inherit;False;Property;_Tiling;Tiling;12;0;Create;True;0;0;0;False;0;False;1,1;1,0.75;0;3;FLOAT2;0;FLOAT;1;FLOAT;2
...
Node;AmplifyShaderEditor.RangedFloatNode;13;-6241.063,-418.1373;Inherit;False;Property;_Speed;Speed;1;0;Create;True;0;0;0;False;0;False;3;1;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.CommentaryNode;83;-4406.677,683.5999;Inherit;False;1805.239;1040.284;Comment;11;120;111;106;99;93;91;89;87;86;85;205;Refraction;1,1,1,1;0;0
...
Node;AmplifyShaderEditor.FunctionNode;205;-3971.448,1217.976;Inherit;False;DepthMaskedRefraction;-1;;1;c805f061214177c42bca056464193f81;2,40,0,103,0;2;35;FLOAT3;0,0,0;False;37;FLOAT;0.02;False;1;FLOAT2;38
...
WireConnection;205;35;86;0
WireConnection;205;37;85;0
...
WireConnection;209;0;164;0
WireConnection;209;1;137;0
WireConnection;209;7;134;0
WireConnection;209;9;189;0
WireConnection;209;11;136;0
ASEEND*/
//CHKSM=ADD1171EE2335FB26FFF13614AA074A4B14B8BB3